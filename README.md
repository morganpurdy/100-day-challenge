...
## Day 40
So yesterday I didn't miss out on coding time, I just didn't get a chance to log it. Lately I have been working on some mockups using HTML and CSS. Coding these mockups based on a given image has been extremely useful and is a good skill to have. So much so that I'm thinking of taking it a step further. I think for practice it would be really great to do this more in my spare time. I should look at sites with design or features I admire or even, on the other side, sites that I think could be done better! The site for my apartment complex is pretty simple but doesn't have the best looking design. I think that would be an interesting challenge for me and would definitely be good practice and a way to improve my skills. Just a thought. I won't have much time to do anything today but wanted to check in and keep plugging along.

## Days 41 and 42
It seems I skipped another day! Thursdays are always kind of busy for me so I didn't get a chance to do any coding activities. However, today I got back into the swing of things with some Javascript lessons. I know I said in previous days that maybe I would focus more on doing some mockups, but I want to do that when I really have the time to sit down and devote to doing it well. I could have started it today but then I would have gotten really involved and probably not able to tear myself away from it easily. So I squeezed in some freecodecamp lessons. I learned more about Javascript objects and properties and actually started getting into Javascript loops, which are interesting! I'll have some more time tomorrow to focus on things so maybe then I'll work on some mock ups.

## Day 43
Today I did start on a mockup! I decided to start from the very beginning. I sketched out a wireframe of sorts for the home page and then after that I went for it. I am loosely basing it off the site for the apartment complex I live in because I think I do better if I have a guide of some kind rather than just winging it. And so far so good! It really is such good practice for HTML and CSS fundamentals. You can just try things out and see how they look. I am trying out a tabbed nav bar on this one and just different styles with color and text-decorations, etc. I will also be adding multiple pages to this practice site to try out various layouts that way too. I did the home page with a large central image and then started on the "location" page. Just some paragraphs and an image. Simple so far, but great practice!

## Day 44
I spent more time on my mockup today! I am adding more pages to it to build on the idea of trying different things on different pages. The ones I have added so far have been pretty simple. But one page is kind of a "look inside" the apartments type page and I think it would be cool to build like a gallery/photo slider thing so the user can click through pictures. That would be great practice! And maybe something I could eventually add to my own portfolio page. I have built one in the past so maybe I can look at that for reference. But I would hope to improve upon that one at this point.

Another thought I just had while sort of rebuilding this site is that there is no nav bar on every page! (On the site I am using for guidance that is). The user has to click back to the home page every time for navigation, and that's just not that user friendly. So without even having noticed this before, my site has a nav bar on every page so all the pages are accessible.

## Day 45
I worked a little more on my practice apartment website today. I embedded a map for directions on the "location" page. On the "a peek inside" page I got a Bootstrap carousel up and running with images that would show the inside of a sample apartment. At first it wasn't working but then I realized I wasn't linking to the right scripts in my document. It's nice to have such a simple fix. Just paste in the correct code and BOOM, your carousel actually works. I did that page and started with contact page as well. Same issue with my portfolio page, I know how to set up a contact form by looks but not how to get it to function. It doesn't really matter for a practice site but still something I'm curious about. I also personalized the styles of some of these bootstrap elements to more match my fake site. I changed the button style and color. Then, after a short google search, I realized you can change the type of the placeholder text in a form. That's pretty cool! And it wasn't difficult either. So that adds a nice touch as well I think.

Maybe I'll get to some Javascript lessons yet today too, we'll see!

## Day 46
Today I did a couple of the FreeCodeCamp Javascript lessons. I was iterating with Javascript for loops, counting backwards and also by odd and even numbers. That was all going along smoothly and then I came to a lesson called "Nesting for loops" and my brain came to a halt. I think I'm going to have to look a little deeper into the nesting ones specifically because it seems a little trickier. The other day I did do a couple more lessons and was able to start thinking in Javascript so to speak. That was a good feeling! I didn't really work on the site mockup today, I need to think about what on there I want to tackle next. Maybe I can do some research and see what kind of styles and elements other similar sites use and then try to implement those on my site as well for practice.   

## Day 47
So technically it is after midnight but to me it's still day 47. I did some more javascript lessons on FreeCodeCamp and got past "Nesting For Loops" but I don't think I truly understood what it all meant. I'd like to revisit that topic. I did get to another big challenge though, a profile lookup. I need to write a function that should check an object's properties and return the value of the property if they are both true. Followed by returning other comments if other statements are found to be true. I am starting with an if statement and some other else if statements. I also am using hasOwnProperty to check on the properties. I have confidence that I can figure this out! But I haven't gotten all the way there yet.

I also worked through some Codecademy lessons later in the day. I was actually going over some lessons I have done before, like the later parts of the CSS course, as a refresher on fundamentals. I think it might be good to go through the Javascript lessons on there too to supplement my freecodecamp learning. That way I can learn about some of the same topics in two different ways to solidify my knowledge and make sure I understand!

## Day 48
I am still working on the profile lookup lesson I mentioned yesterday. I peeked at hint though to help me head in the right direction. It needs to be an if statement nested in a for loop... so I have that to go off the next time I sit down and work on FreeCodeCamp.

I did a lot more reading about coding tonight than actual coding. I get emails through FreeCodeCamp that are a round up of some helpful articles from this week. I read one article called **"A beginner’s guide to website optimization"**: https://medium.freecodecamp.org/a-beginners-guide-to-website-optimization-2185edca0b72 . As I go forward working on my portfolio page and practice sites this is going to be vital info to have! The article only touched briefly on a few topics but definitely things to keep in mind.
...
## Day 51
Today I enjoyed chatting with everyone about code and where they are at in their journey/careers. We also discussed javascript some today! It really is such an important language. So kind of based on that I kept up with Codecademy a little tonight and finished the advanced CSS section I was on. Then I headed into "introduction to javascript". Some of it was a little slow in the beginning since I do know some of the fundamentals already. But it's interesting to see how Codecademy presents javascript as opposed to how freecodecamp does. I think Codecademy might spell it out a little more, but it seems helpful right now. I am using it as a refreshing to really solidify my foundation in javascript so that is perfect. I did learn about let and const variables already, which weren't really even mentioned in all the lessons I took so far in freecodecamp, so that's cool too.
...
## Day 62
So I skipped logging yesterday but did get some coding time in before work. I worked a little more on the practice apartment site I have been building. I added a page and fussed a little with the footer. I have a consistent footer element that goes across the bottom of all pages. I have been googling around for a bit to solve my problem: the footer just sits at the bottom of the content/container, not the viewport of whatever device you are on. So on pages where you scroll because there is a lot of content, it makes sense because it is at the bottom. But on pages with maybe just 3 lines of text, the footer comes immediately after and looks like it's just floating. I have found some solutions and tried to implement them but they didn't work for me. Maybe it's really simple and I'm overlooking things! I just have yet to find a way to do the footer that works on both types of pages. Maybe I can try to find a solution tonight or I may just work on some more Codecademy lessons.
...
## Day 90
I really put in some work on my portfolio page tonight. I readjusted the layout a little and added pages, turning it into a multiple page website as opposed to the one page scrolling site I had to build for FreeCodeCamp. I think it's looking good! Some of my next steps include adding a Bootstrap carousel to display my print designs and fixing the web.html page because right now the color isn't filling the whole background, if that makes sense. Should be pretty simple. Tonight I have had some really good practice in HTML/CSS fundamentals! And also having to be sure I typed something correctly haha. I'm hoping to get back to javascript in the near future but this is my focus right now.

## Day 91
My coding is a little light today but we are closing in on one hundred days! That's pretty exciting. I have been coding up my portfolio page a little more and am hoping to get some feedback from the group and post it today. This has been my focus as I know that one of my goals at the beginning of the hundred days was to make a portfolio site. After the hundred days I do have another challenge in mind to keep me going! So that is on my mind as well.

## Day 92
Today rocked! I didn't code a lot but what I added to my portfolio site was great. Instead of a carousel for my print work I used a Fancybox javascript library which I have used in the past. That way, when someone clicks on my design it expands and gives them more details about it. > info here: https://fancyapps.com/fancybox/3/
...
## Day 101
So I totally got off counting somehow in our challenge, but yesterday was officially day 100! We made it to the end! At the beginning of my 100 day challenge I made a goal list for the things I wanted to accomplish during my 100 days. I did the first two: learn github (mostly) and rebuild my personal website. That's awesome! I still have more to learn in terms of github with contributions and forking, etc. but I have the basics down I think, and that's a good start. My personal website now I think will be a continuing work in progress but I have a design/setup I really like. I just need to build more things to add to it. One of my other goals was to 'read about responsive design' which I definitely did a lot of. I think my biggest success on that front came when I found a tutorial for media queries and learned why they weren't working for me before. That was a good day.

So looking back over the 100 days I feel like I have come a long way from where I started but still have so much further to go. I don't want to waste everything I've done so here on day 101 I want to set up a new goal list for myself! Here is what I am hoping to accomplish going forward:
* **Get a better grasp on Javascript.** I have been going through the Javascript lessons on both Codecademy and freecodecamp. I am focused on finishing Codecademy first (so I don't have TOO many different lessons going on) but I also signed up for Wes Bos's 30 day Javascript challenge! I have all the files and am ready to go and hoping to start with the Drum Kit challenge tomorrow.
* **Learn more about Wordpress coding.** I see a lot out there on Wordpress still and this was one of my goals for the original 100 days. I think going forward I may start doing updates on Wordpress blog. That way I can learn about Wordpress coding while also holding myself accountable for continuing to learn by updating a blog.
* **Build more things.** This is so generic but in general I just want to keep learning and building! I didn't build too much during the first 100 days I think because I was focused more on lessons, and that's cool. But as I keep going I think building things as a way to learn and practice is the way to go.  
